...
import 'package:flash/screens/news/economy/economy_news_detail.dart';
    ...
    return Scaffold(
      ...
      body: Obx(() {
          return newsController.stillFetching.value? const Center(child: CircularProgressIndicator()) : NewsListWidget(
            ...
            titleText: newsController.economyNewsList[0].title!,//"The world's higest paid footballers and managers in 2020 have been named-GIVEMESPORT",
            headerImage: newsController.economyNewsList[0].urlToImage!,//'assets/images/economy.jpg',
            sliverDelegate: SliverChildBuilderDelegate(
              ((context, index) {

                var economyNews = newsController.economyNewsList[index];
                    ...
                    Material(
                      ...
                      child: Container(
                        child: Padding(
                          ...
                          child: InkWell(
                            onTap: () {
                              Get.to(EconomyNewsDetailScreen(newsArticle: economyNews));
                            },
                            child: Row(
                              // crossAxisAlignment: CrossAxisAlignment.end,
                              children: [
                                // Image: first item in the outer Row
                                economyNews.urlToImage! == null? CircularProgressIndicator() : Container(
                                  ...
                                  decoration: BoxDecoration(
                                      image: DecorationImage(
                                        fit: BoxFit.cover,
                                        image: NetworkImage(economyNews.urlToImage!),//AssetImage(screenData[index]['image']),
                                      ),
                                      ...
                                      Container(
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            Expanded(
                                              child: Text(
                                                economyNews.publishedAt!,//'08 February',
              ...
              childCount: newsController.economyNewsList.length,
            ),
          );
        }
      ),
