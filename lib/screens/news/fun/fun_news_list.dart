...
import 'package:flash/screens/news/fun/fun_news_detail.dart';
    ...
    return Scaffold(
      ...
      body: Obx(() {
          return newsController.stillFetching.value? const Center(child: CircularProgressIndicator()) : NewsListWidget(
            ...
            titleText: newsController.funNewsList[0].title!,//"The world's higest paid footballers and managers in 2020 have been named-GIVEMESPORT",
            headerImage: newsController.funNewsList[0].urlToImage!,//'assets/images/economy.jpg',
            sliverDelegate: SliverChildBuilderDelegate(
              ((context, index) {

                var funNews = newsController.funNewsList[index];
                    ...
                    Material(
                      ...
                      child: Container(
                        child: Padding(
                          ...
                          child: InkWell(
                            onTap: () {
                              Get.to(FunNewsDetailScreen(newsArticle: funNews));
                            },
                            child: Row(
                              // crossAxisAlignment: CrossAxisAlignment.end,
                              children: [
                                // Image: first item in the outer Row
                                funNews.urlToImage! == null? CircularProgressIndicator() : Container(
                                  ...
                                  decoration: BoxDecoration(
                                      image: DecorationImage(
                                        fit: BoxFit.cover,
                                        image: NetworkImage(funNews.urlToImage!),//AssetImage(screenData[index]['image']),
                                      ),
                                      ...
                                      Container(
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            Expanded(
                                              child: Text(
                                                funNews.publishedAt!,//'08 February',
              ...
              childCount: newsController.funNewsList.length,
            ),
          );
        }
      ),
